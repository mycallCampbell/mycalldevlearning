...
class Blog(models.Model):
    ...
    captchaPhrase1 = models.TextField(null=True, blank=True)
    captchaPhrase2 = models.TextField(null=True, blank=True)
    ...
    description12 = models.TextField(null=True, blank=True)
    description13 = models.TextField(null=True, blank=True)
    description14 = models.TextField(null=True, blank=True)
    description15 = models.TextField(null=True, blank=True)
    orderList1 = models.CharField(max_length=300, null=True, blank=True)
    orderList2 = models.CharField(max_length=300, null=True, blank=True)
    orderList3 = models.CharField(max_length=300, null=True, blank=True)
    orderList4 = models.CharField(max_length=300, null=True, blank=True)
    orderList5 = models.CharField(max_length=300, null=True, blank=True)
